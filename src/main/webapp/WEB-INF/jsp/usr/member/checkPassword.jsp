       		...
       		<colgroup>
       			...
       			<tbody>
       				...
       				<tr> 
       					<th>로그인 비밀번호</th>
       					<td>
       						<input required="required" type="password" class="w-96 input input-boardered w-full max-w-xs" name="loginPwInput" placeholder="로그인비밀번호" />
       					</td>
       				</tr>
       				<tr>
       					<th>비밀번호 확인</th>
       					<td>
       						<input type="submit" class="btn btn-warning"  value="비밀번호 확인" />
