            ...
            <td>
            	<div class="flex items-center">
            		...
            		<c:if test="${actorCanCancelGoodReaction}">
	            		...
	            		<span>&nbsp;</span>
						<a onclick="alert(this.title); return false;" title="먼저 좋아요를 취소하세요" href="#" class="btn btn-xs btn-outline btn-secondary">
							싫어요 👎
						</a>
            		</c:if>
            		<c:if test="${actorCanCancelBadReaction}">
	            		<a onclick="alert(this.title); return false;" title="먼저 싫어요를 취소하세요" href="#" class="btn btn-xs btn-outline btn-primary">
	            			좋아요 👍
	            		</a>
	            		<span>&nbsp;</span>
